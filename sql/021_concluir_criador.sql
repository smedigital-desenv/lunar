-- =====================================================================
-- 021_concluir_criador.sql
-- Ajuste de permissão de conclusão: além do responsável atual e da chefia,
-- também podem concluir o CRIADOR e o SOLICITANTE da demanda (quem coordena
-- a demanda de ponta a ponta, mesmo que a responsabilidade tenha sido
-- encaminhada a outra pessoa no meio do caminho).
-- Substitui a versão de sql/019. Sistema de Gestão de Demandas — SME RP.
-- =====================================================================
...
begin
  ...
  -- Responsável atual, criador, solicitante ou chefia (gerente+/gabinete).
  if not (v_autor = d.responsavel_atual_id
    ...
    raise exception 'Apenas o responsável, o criador/solicitante ou a chefia podem concluir a demanda.'
