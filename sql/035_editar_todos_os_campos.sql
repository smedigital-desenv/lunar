-- =====================================================================
-- 035_editar_todos_os_campos.sql
-- "Editar demanda" só deixava corrigir título, descrição, objeto/queixa
-- (nem exposto no front até agora), categoria, prioridade, prazo, escola
-- e aluno. Faltavam: tipo, setor, sigilo e nº do processo Solar — todos
-- preenchíveis na criação (nova-demanda.html), mas sem como corrigir
-- depois. Adiciona os quatro à mesma função, sem tocar nas checagens de
-- permissão de responsável introduzidas em sql/034.
