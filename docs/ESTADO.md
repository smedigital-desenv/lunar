...
- **Pendente:** as 43 pessoas do organograma oficial ainda **não** estão cadastradas. Faltam os e-mails institucionais; não inventar — ou a secretaria informa a lista, ou cada pessoa entra pelo central e um admin libera em `pages/admin.html`.
