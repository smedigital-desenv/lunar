...
**Última atualização:** 2026-08-01 (Sessões 2, 4, 5, 6, 7 e 8)
**Fase atual:** Sessões 1, 2, 5, 6, 7 e 8 concluídas. Sessão 4 (serviços) em evolução.

> `sql/009_dashboard_pesquisa.sql` (funções do painel/busca + índice GIN de movimentações) **executado no Supabase em 2026-08-01.**
